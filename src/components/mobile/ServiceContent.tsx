      ...
      <div className="supported">
        ...
        <div className="supported-box">
          <div className="box-img">
            <img src="/images/group1203.png" alt="" />
            <span
              className="box-l"
              style={{
                position: "absolute",
          ...
          <div className="box-img">
            <img src="/images/group1210.png" alt="" />
            <span
              className="box-l"
              style={{
                position: "absolute",
        ...
        <div className="supported-box">
          <div className="box-img">
            <img src="/images/group1212.png" alt="" />
            <span
              className="box-l"
              style={{
                position: "absolute",
          ...
          <div className="box-img">
            <img src="/images/group1214.png" alt="" />
            <span
              className="box-l"
              style={{
                position: "absolute",
          ...
          <div className="box-img">
            <img src="/images/group1209.png" alt="" />
            <span
              className="box-l"
              style={{
                position: "absolute",
