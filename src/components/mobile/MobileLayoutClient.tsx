        ...
        <Modal.Body>
          ...
          <table className="modal-table">
            <tbody>
              ...
              <tr>
                <td>
                  <Link href="/mobile/route/introduce">
              ...
              <tr>
                <td>
                  <Link href="/mobile/route/service">
              ...
              <tr>
                <td>
                  <Link href="/mobile/route/news">{t.newspage as string}</Link>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="mobile-button-box">
            <Link href="/mobile/route/adopt" className="adopt-link">
              <button className="topbutton">{t.Recurit as string}</button>
            </Link>

            <Link href="/mobile/route/consult" className="consult-link">
