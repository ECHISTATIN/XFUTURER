...
const MapComponent = dynamic(() => import('@/components/mobile/MapComponent'), { ssr: false })
...
export default function IntroduceContent({
  ...
  return (
    ...
    <div className='message-in'>
      ...
      <img src="/images/li ne62.png" alt="Contact" style={{
        height: '1px',
        width: '159px'
      }} />
...
display: 'block'         // 强制元素为块级显示
      }}>{t.introduce.trust_and_growth}</span>
      <div style={{
        fontWeight: '500',
        fontSize: '28px',
        letterSpacing: '1.7px',
    ...
    <div className='profile'>
      ...
      <span style={{
        ...
        fontSize: '28px',
        letterSpacing: '1.7px',
      }}>{t.introduce.company_profile}</span>
      ...
      <div className='profile-tb'>
        <div style={{
          ...
          <div className='tb-line'>
            ...
            <div className='tb-f2' style={{
              display:'flex',
              flexDirection:'column'
            }}><span>{t.introduce.business_activities_value1}</span>
            <span>{t.introduce.business_activities_value2}</span></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div style={{
      ...
      <span style={{
        ...
        wordBreak: 'break-word', // 强制文本换行
        display: 'block'         // 强制元素为块级显示
      }}>{t.introduce.address_full_1}</span>
              <span style={{
        fontWeight: '400',
        fontSize: '26px',
        letterSpacing: '1.6px',
        ...
        wordBreak: 'break-word', // 强制文本换行
        display: 'block'         // 强制元素为块级显示
      }}>{t.introduce.address_full_2}</span>
      ...
      <div className='traffic' style={{
        ...
        <img src='/images/group630.png' style={{
          width:'34px',
          height:'46px'
        }}></img>
      ...
      <div className='google'>
        <Link href="https://www.google.com/maps?q=〒103-0007+東京都中央区日本橋浜町３-２３-１ACN日本橋リバーサイドビル８Ｆ"
          target="_blank"
          rel="noopener noreferrer">{t.introduce.view_google_map}</Link>
      </div>
    </div>
